...
const DBUS_INTERFACE_NAME = 'io.github.keysharp.GnomeShell1';
...
export default class KeysharpExtension {
    ...
    // correctly. A minimized window has no live texture and yields an empty result (the client then
    ...
    _emitActiveWindowChanged() {
        ...
        try {
            const json = this._getActiveWindow();
